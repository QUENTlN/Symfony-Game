 ...
 */
final class Version20210206203351 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, room_settings_id INT DEFAULT NULL, host_id INT NOT NULL, link_room VARCHAR(400) NOT NULL, created_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, is_private TINYINT(1) NOT NULL, INDEX IDX_729F519B4DA136B7 (room_settings_id), INDEX IDX_729F519B1FB8D185 (host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
