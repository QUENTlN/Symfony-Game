 ...
 */
final class Version20210204211606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, room_settings_id INT DEFAULT NULL, id_host_id INT NOT NULL, link_room VARCHAR(400) NOT NULL, created_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, is_private TINYINT(1) NOT NULL, INDEX IDX_729F519B4DA136B7 (room_settings_id), INDEX IDX_729F519BC12578F5 (id_host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE room_settings (id INT AUTO_INCREMENT NOT NULL, id_player_id INT DEFAULT NULL, nb_max_player INT NOT NULL, show_score INT NOT NULL, created_at DATETIME NOT NULL, one_answer_only TINYINT(1) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_45A3600119D349F8 (id_player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE room ADD CONSTRAINT FK_729F519BC12578F5 FOREIGN KEY (id_host_id) REFERENCES player (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room DROP FOREIGN KEY FK_729F519BC12578F5');
