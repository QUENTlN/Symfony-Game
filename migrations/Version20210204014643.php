 ...
 */
final class Version20210204014643 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE guest (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(25) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE player (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(25) NOT NULL, login VARCHAR(255) NOT NULL, password VARCHAR(100) NOT NULL, is_admin TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, sub_category_id INT NOT NULL, text_question LONGTEXT NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_B6F7494E99E6F5DF (player_id), INDEX IDX_B6F7494EF7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, room_settings_id INT DEFAULT NULL, link_room VARCHAR(400) NOT NULL, created_at DATETIME NOT NULL, finished_at DATETIME DEFAULT NULL, is_private TINYINT(1) NOT NULL, INDEX IDX_729F519B99E6F5DF (player_id), INDEX IDX_729F519B4DA136B7 (room_settings_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE room_settings (id INT AUTO_INCREMENT NOT NULL, host_id INT NOT NULL, nb_max_player INT NOT NULL, show_score INT NOT NULL, created_at DATETIME NOT NULL, one_answer_only TINYINT(1) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_45A360011FB8D185 (host_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE room_settings ADD CONSTRAINT FK_45A360011FB8D185 FOREIGN KEY (host_id) REFERENCES player (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE room_settings DROP FOREIGN KEY FK_45A360011FB8D185');
